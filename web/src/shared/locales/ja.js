...
export default {
  'common.closeNamed': '{name}を閉じる',
  'index.dateToday': '今日',
  'index.dateYesterday': '昨日',
  'index.datePrevious7Days': '過去7日間',
  'index.datePrevious30Days': '過去30日間',
  'index.dateOlder': 'それ以前',
  'index.loadMore': 'さらに読み込む',
  'index.loadingMore': '読み込み中…',
  'menu.renamePrompt': 'セッションの名前を変更',
  'menu.renamed': '名前を変更しました',
  'menu.forkFailed': 'フォークに失敗しました',
  'menu.noUserMessagesToFork': 'フォークするユーザーメッセージがありません',
  'menu.loadMessagesFailed': 'メッセージの読み込みに失敗しました',
  'menu.cloneFailed': 'クローンに失敗しました',
  'menu.notImplemented': 'まだ実装されていません',
  // ── Diff review modal ──
  'diff.title': 'Diff',
  ...
  'diff.expandFile': 'ファイルを展開',
  'composer.modelPlaceholder': 'モデル',
  'share.defaultTitle': 'セッションを共有',
  'share.failedTitle': '共有に失敗しました',
  'share.successTitle': 'セッションを共有しました',
  'share.gistUrlLabel': 'Gist URL',
  'share.previewUrlLabel': 'プレビューURL',
  'share.copyGist': 'Gistをコピー',
  'share.copyPreview': 'プレビューをコピー',
  'share.gistLabel': 'Gist',
  'share.previewLabel': 'プレビュー',
  'share.networkError': 'ネットワークエラー',
  'common.cancel': 'キャンセル',
  'common.close': '閉じる',
  'common.create': '作成',
  'common.add': '追加',
  ...
  'composer.queueActive': 'キュー',
  'composer.queuePaused': 'キュー一時停止',
  'composer.queueQueuedCount': 'キュー待ち',
  'composer.queueSteeringCount': '誘導中',
  'composer.pause': '一時停止',
  'composer.resume': '再開',
  'composer.queuePauseHint': '再開するまでキュー内のメッセージを保留します',
  'composer.queueResumeHint': '現在の応答が終了したら、キュー内のメッセージを自動送信します',
  'composer.queueAria': '保留中のメッセージ',
  'composer.steerTag': '誘導中',
  'composer.queueNavigate': '移動',
  ...
  // ── Schedules ──
  'schedules.navTitle': 'スケジュール',
  'schedules.title': 'スケジュール',
  'schedules.new': '新しいスケジュール',
  'schedules.edit': '編集',
  'schedules.delete': '削除',
  'schedules.backToSessions': 'セッション',
  'schedules.loading': '読み込み中…',
  'schedules.emptyTitle': 'スケジュールはまだありません',
  'schedules.emptyHint': 'スケジュールを作成して、pi をタイマーで自動実行しましょう。',
  'schedules.active': '有効',
  ...
  'schedules.resume': '再開',
  'schedules.runs': '実行回数',
  'schedules.noRuns': '実行履歴はまだありません',
  'schedules.runError': 'エラー',
  'schedules.openSession': 'セッションを開く',
  'schedules.runStarted': '開始しました…',
  'schedules.confirmDelete': 'スケジュール「{name}」を削除しますか？',
  'schedules.editorTitle': 'スケジュールエディター',
  'schedules.editTitle': 'スケジュールを編集',
  'schedules.saving': '保存中…',
  'schedules.fieldName': '名前',
  'schedules.namePlaceholder': '毎日のスタンドアップダイジェスト',
  'schedules.fieldInstructions': '指示',
  'schedules.instructionsPlaceholder': '各実行で pi に何をさせますか？',
  'schedules.fieldProject': 'プロジェクトディレクトリ',
  'schedules.projectPlaceholder': '/path/to/project（デフォルト: home）',
  'schedules.fieldModel': 'モデル',
  'schedules.modelDefault': 'デフォルト（pi が選択）',
  'schedules.modelClear': 'クリア',
  'schedules.modelSearch': 'モデルを検索…',
  'schedules.modelNone': '一致するモデルがありません',
  'schedules.fieldThinking': '思考レベル',
  'schedules.thinkingDefault': 'デフォルト',
  'schedules.fieldFrequency': '頻度',
  'schedules.fieldMinute': '分（0–59）',
  'schedules.fieldTime': '時刻',
  'schedules.fieldWeekday': '曜日',
  'schedules.fieldCron': 'cron 式',
  'schedules.cronHint': '標準の5フィールド cron: 分 時 日 月 曜日',
  'schedules.fieldTimezone': 'タイムゾーン',
  'schedules.fieldEnabled': '有効',
  'schedules.errNameRequired': '名前は必須です',
  'schedules.errInstructionsRequired': '指示は必須です',
  'schedules.errCronRequired': 'cron 式が必要です',
  'schedules.freq_manual': '手動のみ',
  'schedules.freq_hourly': '毎時',
  'schedules.freq_daily': '毎日',
  'schedules.freq_weekdays': '平日',
  'schedules.freq_weekly': '毎週',
  'schedules.freq_custom': 'カスタム（cron）',
  'schedules.freqManual': '手動のみ',
  'schedules.freqHourlyAt': '毎時 :{minute} 分',
  'schedules.freqDailyAt': '毎日 {time}',
  'schedules.freqWeekdaysAt': '平日 {time}',
  'schedules.freqWeeklyAt': '{day} {time}',
  'schedules.weekday0': '日曜日',
  'schedules.weekday1': '月曜日',
  'schedules.weekday2': '火曜日',
  'schedules.weekday3': '水曜日',
  'schedules.weekday4': '木曜日',
  'schedules.weekday5': '金曜日',
  'schedules.weekday6': '土曜日',
  // ── Not found (404) ──

...
export default {
  'common.closeNamed': 'Cerrar {name}',
  'index.dateToday': 'Hoy',
  'index.dateYesterday': 'Ayer',
  'index.datePrevious7Days': 'Últimos 7 días',
  'index.datePrevious30Days': 'Últimos 30 días',
  'index.dateOlder': 'Más antiguas',
  'index.loadMore': 'Cargar más',
  'index.loadingMore': 'Cargando…',
  'menu.renamePrompt': 'Renombrar sesión',
  'menu.renamed': 'Renombrada',
  'menu.forkFailed': 'Error al bifurcar',
  'menu.noUserMessagesToFork': 'No hay mensajes de usuario para bifurcar',
  'menu.loadMessagesFailed': 'Error al cargar los mensajes',
  'menu.cloneFailed': 'Error al clonar',
  'menu.notImplemented': 'Aún no implementado',
  // ── Diff review modal ──
  'diff.title': 'Diff',
  'diff.loading': 'Cargando diff…',
  'diff.timeout': 'Se agotó el tiempo del diff: inténtalo de nuevo.',
  'diff.empty': 'No hay cambios sin confirmar',
  ...
  'diff.expandFile': 'Expandir archivo',
  'composer.modelPlaceholder': 'Modelo',
  'share.defaultTitle': 'Compartir sesión',
  'share.failedTitle': 'Error al compartir',
  'share.successTitle': 'Sesión compartida',
  'share.gistUrlLabel': 'URL del Gist',
  'share.previewUrlLabel': 'URL de vista previa',
  'share.copyGist': 'Copiar Gist',
  'share.copyPreview': 'Copiar vista previa',
  'share.gistLabel': 'Gist',
  'share.previewLabel': 'Vista previa',
  ...
  'composer.queueActive': 'Cola',
  'composer.queuePaused': 'Cola pausada',
  'composer.queueQueuedCount': 'en cola',
  'composer.queueSteeringCount': 'dirigiendo',
  'composer.pause': 'Pausar',
  'composer.resume': 'Reanudar',
  'composer.queuePauseHint': 'Mantener los mensajes en cola hasta reanudar',
  'composer.queueResumeHint':
    'Enviar automáticamente los mensajes en cola al terminar la ejecución actual',
  'composer.queueAria': 'Mensajes pendientes',
  'composer.steerTag': 'dirigiendo',
  'composer.queueNavigate': 'navegar',
  'composer.queueEdit': 'editar',
  'composer.queueDelete': 'eliminar',
  'composer.queueSendNow': 'enviar ahora',
  'composer.queueExit': 'salir',
  'composer.queueSavedLocally': 'envío automático',
  'composer.queueSavedLocallyHint':
    'Los mensajes en cola se guardan en el servidor y se enviarán automáticamente cuando el trabajador esté inactivo — incluso si cierras el navegador',
  ...
  // ── Schedules ──
  'schedules.navTitle': 'Programaciones',
  ...
  'schedules.runs': 'Ejecuciones',
  'schedules.noRuns': 'Aún no hay ejecuciones',
  'schedules.runError': 'Error',
  'schedules.openSession': 'Abrir sesión',
  'schedules.runStarted': 'Iniciada…',
  'schedules.confirmDelete': '¿Eliminar la programación “{name}”?',
  'schedules.editorTitle': 'Editor de programaciones',
  'schedules.editTitle': 'Editar programación',
  'schedules.saving': 'Guardando…',
  'schedules.fieldName': 'Nombre',
  'schedules.namePlaceholder': 'Resumen diario del standup',
  'schedules.fieldInstructions': 'Instrucciones',
  'schedules.instructionsPlaceholder': '¿Qué debe hacer pi en cada ejecución?',
  'schedules.fieldProject': 'Directorio del proyecto',
  'schedules.projectPlaceholder': '/ruta/al/proyecto (predeterminado: home)',
  'schedules.fieldModel': 'Modelo',
  'schedules.modelDefault': 'Predeterminado (pi elige)',
  'schedules.modelClear': 'Borrar',
  'schedules.modelSearch': 'Buscar modelos…',
  'schedules.modelNone': 'No hay modelos que coincidan',
  'schedules.fieldThinking': 'Nivel de razonamiento',
  'schedules.thinkingDefault': 'Predeterminado',
  'schedules.fieldFrequency': 'Frecuencia',
  'schedules.fieldMinute': 'Minuto (0–59)',
  'schedules.fieldTime': 'Hora',
  'schedules.fieldWeekday': 'Día de la semana',
  'schedules.fieldCron': 'Expresión cron',
  'schedules.cronHint': 'cron estándar de 5 campos: minuto hora día mes día de la semana',
  'schedules.fieldTimezone': 'Zona horaria',
  'schedules.fieldEnabled': 'Habilitada',
  'schedules.errNameRequired': 'El nombre es obligatorio',
  'schedules.errInstructionsRequired': 'Las instrucciones son obligatorias',
  'schedules.errCronRequired': 'Se requiere una expresión cron',
  'schedules.freq_manual': 'Solo manual',
  'schedules.freq_hourly': 'Cada hora',
  'schedules.freq_daily': 'Diaria',
  'schedules.freq_weekdays': 'Días laborables',
  'schedules.freq_weekly': 'Semanal',
  'schedules.freq_custom': 'Personalizada (cron)',
  'schedules.freqManual': 'Solo manual',
  'schedules.freqHourlyAt': 'Cada hora en :{minute}',
  'schedules.freqDailyAt': 'A diario a las {time}',
  'schedules.freqWeekdaysAt': 'Días laborables a las {time}',
  'schedules.freqWeeklyAt': '{day} a las {time}',
  'schedules.weekday0': 'Domingo',
  'schedules.weekday1': 'Lunes',
  'schedules.weekday2': 'Martes',
  'schedules.weekday3': 'Miércoles',
  'schedules.weekday4': 'Jueves',
  'schedules.weekday5': 'Viernes',
  'schedules.weekday6': 'Sábado',
  // ── Not found (404) ──

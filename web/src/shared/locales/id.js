...
export default {
  ...
  'index.dateYesterday': 'Kemarin',
  'index.datePrevious7Days': '7 hari terakhir',
  'index.datePrevious30Days': '30 hari terakhir',
  'index.dateOlder': 'Lebih lama',
  'index.loadMore': 'Muat lebih banyak',
  'index.loadingMore': 'Memuat…',
  'menu.renamePrompt': 'Ganti nama sesi',
  'menu.renamed': 'Nama diganti',
  'menu.forkFailed': 'Fork gagal',
  'menu.noUserMessagesToFork': 'Tidak ada pesan pengguna untuk di-fork',
  'menu.loadMessagesFailed': 'Gagal memuat pesan',
  'menu.cloneFailed': 'Gagal mengkloning',
  'menu.notImplemented': 'Belum diimplementasikan',
  // ── Diff review modal ──
  'diff.title': 'Diff',
  ...
  'diff.expandFile': 'Bentangkan berkas',
  'composer.modelPlaceholder': 'Model',
  'share.defaultTitle': 'Bagikan sesi',
  'share.failedTitle': 'Gagal Membagikan',
  'share.successTitle': 'Sesi Dibagikan',
  'share.gistUrlLabel': 'URL Gist',
  'share.previewUrlLabel': 'URL Pratinjau',
  'share.copyGist': 'Salin Gist',
  'share.copyPreview': 'Salin Pratinjau',
  'share.gistLabel': 'Gist',
  'share.previewLabel': 'Pratinjau',
  'share.networkError': 'Kesalahan jaringan',
  'common.cancel': 'Batal',
  'common.close': 'Tutup',
  'common.create': 'Buat',
  'common.add': 'Tambah',
  ...
  'composer.queueActive': 'Antrean',
  'composer.queuePaused': 'Antrean dijeda',
  'composer.queueQueuedCount': 'mengantre',
  'composer.queueSteeringCount': 'mengarahkan',
  'composer.pause': 'Jeda',
  'composer.resume': 'Lanjutkan',
  'composer.queuePauseHint': 'Tahan pesan dalam antrean hingga dilanjutkan',
  'composer.queueResumeHint': 'Otomatis kirim pesan dalam antrean saat proses selesai',
  'composer.queueAria': 'Pesan tertunda',
  'composer.steerTag': 'mengarahkan',
  ...
  // ── Schedules ──
  'schedules.navTitle': 'Jadwal',
  'schedules.title': 'Jadwal',
  'schedules.new': 'Jadwal baru',
  'schedules.edit': 'Edit',
  'schedules.delete': 'Hapus',
  'schedules.backToSessions': 'Sesi',
  'schedules.loading': 'Memuat…',
  'schedules.emptyTitle': 'Belum ada jadwal',
  'schedules.emptyHint': 'Buat jadwal untuk menjalankan pi secara otomatis dengan pengatur waktu.',
  'schedules.active': 'Aktif',
  'schedules.paused': 'Dijeda',
  'schedules.next': 'Berikutnya',
  'schedules.last': 'Terakhir',
  'schedules.runNow': 'Jalankan sekarang',
  'schedules.pause': 'Jeda',
  'schedules.resume': 'Lanjutkan',
  'schedules.runs': 'Jalankan',
  'schedules.noRuns': 'Belum ada yang dijalankan',
  'schedules.runError': 'Kesalahan',
  'schedules.openSession': 'Buka sesi',
  'schedules.runStarted': 'Dimulai…',
  'schedules.confirmDelete': 'Hapus jadwal “{name}”?',
  'schedules.editorTitle': 'Editor jadwal',
  ...
  'schedules.fieldInstructions': 'Instruksi',
  'schedules.instructionsPlaceholder': 'Apa yang harus dilakukan pi pada setiap kali dijalankan?',
  'schedules.fieldProject': 'Direktori proyek',
  'schedules.projectPlaceholder': '/path/ke/proyek (default: home)',
  'schedules.fieldModel': 'Model',
  'schedules.modelDefault': 'Default (pi memilih)',
  'schedules.modelClear': 'Hapus',
  'schedules.modelSearch': 'Cari model…',
  'schedules.modelNone': 'Tidak ada model yang cocok',
  'schedules.fieldThinking': 'Tingkat berpikir',
  'schedules.thinkingDefault': 'Default',
  'schedules.fieldFrequency': 'Frekuensi',
  'schedules.fieldMinute': 'Menit (0–59)',
  'schedules.fieldTime': 'Waktu',
  'schedules.fieldWeekday': 'Hari dalam seminggu',
  'schedules.fieldCron': 'Ekspresi cron',
  'schedules.cronHint': 'cron standar 5 bidang: menit jam hari bulan hari-dalam-seminggu',
  'schedules.fieldTimezone': 'Zona waktu',
  'schedules.fieldEnabled': 'Diaktifkan',
  'schedules.errNameRequired': 'Nama wajib diisi',
  'schedules.errInstructionsRequired': 'Instruksi wajib diisi',
  'schedules.errCronRequired': 'Ekspresi cron diperlukan',
  'schedules.freq_manual': 'Hanya manual',
  'schedules.freq_hourly': 'Setiap jam',
  'schedules.freq_daily': 'Harian',
  'schedules.freq_weekdays': 'Hari kerja',
  'schedules.freq_weekly': 'Mingguan',
  'schedules.freq_custom': 'Kustom (cron)',
  'schedules.freqManual': 'Hanya manual',
  'schedules.freqHourlyAt': 'Setiap jam pada :{minute}',
  'schedules.freqDailyAt': 'Setiap hari pukul {time}',
  'schedules.freqWeekdaysAt': 'Hari kerja pukul {time}',
  'schedules.freqWeeklyAt': '{day} pukul {time}',
  'schedules.weekday0': 'Minggu',
  'schedules.weekday1': 'Senin',
  'schedules.weekday2': 'Selasa',
  'schedules.weekday3': 'Rabu',
  'schedules.weekday4': 'Kamis',
  'schedules.weekday5': 'Jumat',

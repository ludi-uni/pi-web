...
export default {
  'common.closeNamed': '{name} schließen',
  'index.dateToday': 'Heute',
  'index.dateYesterday': 'Gestern',
  'index.datePrevious7Days': 'Letzte 7 Tage',
  'index.datePrevious30Days': 'Letzte 30 Tage',
  'index.dateOlder': 'Älter',
  'index.loadMore': 'Mehr laden',
  'index.loadingMore': 'Wird geladen…',
  'menu.renamePrompt': 'Sitzung umbenennen',
  'menu.renamed': 'Umbenannt',
  'menu.forkFailed': 'Forken fehlgeschlagen',
  'menu.noUserMessagesToFork': 'Keine Benutzernachrichten zum Forken',
  'menu.loadMessagesFailed': 'Nachrichten konnten nicht geladen werden',
  'menu.cloneFailed': 'Klonen fehlgeschlagen',
  'menu.notImplemented': 'Noch nicht implementiert',
  // ── Diff review modal ──
  'diff.title': 'Diff',
  'diff.loading': 'Diff wird geladen…',
  'diff.timeout': 'Zeitüberschreitung beim Diff – bitte erneut versuchen.',
  'diff.empty': 'Keine nicht committeten Änderungen',
  ...
  'diff.expandFile': 'Datei ausklappen',
  'composer.modelPlaceholder': 'Modell',
  'share.defaultTitle': 'Sitzung teilen',
  'share.failedTitle': 'Teilen fehlgeschlagen',
  'share.successTitle': 'Sitzung geteilt',
  'share.gistUrlLabel': 'Gist-URL',
  'share.previewUrlLabel': 'Vorschau-URL',
  'share.copyGist': 'Gist kopieren',
  'share.copyPreview': 'Vorschau kopieren',
  'share.gistLabel': 'Gist',
  'share.previewLabel': 'Vorschau',
  'share.networkError': 'Netzwerkfehler',
  ...
  'composer.queueActive': 'Warteschlange',
  'composer.queuePaused': 'Warteschlange pausiert',
  'composer.queueQueuedCount': 'eingereiht',
  'composer.queueSteeringCount': 'lenkend',
  'composer.pause': 'Pausieren',
  'composer.resume': 'Fortsetzen',
  'composer.queuePauseHint': 'Eingereihte Nachrichten zurückhalten, bis Sie fortsetzen',
  'composer.queueResumeHint':
    'Eingereihte Nachrichten automatisch senden, wenn der aktuelle Lauf endet',
  'composer.queueAria': 'Ausstehende Nachrichten',
  'composer.steerTag': 'lenkend',
  'composer.queueNavigate': 'navigieren',
  ...
  // ── Schedules ──
  'schedules.navTitle': 'Zeitpläne',
  'schedules.title': 'Zeitpläne',
  'schedules.new': 'Neuer Zeitplan',
  'schedules.edit': 'Bearbeiten',
  'schedules.delete': 'Löschen',
  'schedules.backToSessions': 'Sitzungen',
  'schedules.loading': 'Wird geladen…',
  'schedules.emptyTitle': 'Noch keine Zeitpläne',
  'schedules.emptyHint': 'Erstelle einen Zeitplan, um pi automatisch zeitgesteuert auszuführen.',
  'schedules.active': 'Aktiv',
  'schedules.paused': 'Pausiert',
  'schedules.next': 'Nächste',
  'schedules.last': 'Letzte',
  'schedules.runNow': 'Jetzt ausführen',
  'schedules.pause': 'Pausieren',
  'schedules.resume': 'Fortsetzen',
  'schedules.runs': 'Ausführungen',
  'schedules.noRuns': 'Noch keine Ausführungen',
  'schedules.runError': 'Fehler',
  'schedules.openSession': 'Sitzung öffnen',
  'schedules.runStarted': 'Gestartet…',
  'schedules.confirmDelete': 'Zeitplan „{name}“ löschen?',
  'schedules.editorTitle': 'Zeitplan-Editor',
  'schedules.editTitle': 'Zeitplan bearbeiten',
  'schedules.saving': 'Wird gespeichert…',
  'schedules.fieldName': 'Name',
  'schedules.namePlaceholder': 'Tägliche Standup-Zusammenfassung',
  'schedules.fieldInstructions': 'Anweisungen',
  'schedules.instructionsPlaceholder': 'Was soll pi bei jeder Ausführung tun?',
  'schedules.fieldProject': 'Projektverzeichnis',
  'schedules.projectPlaceholder': '/pfad/zum/projekt (Standard: Home)',
  'schedules.fieldModel': 'Modell',
  'schedules.modelDefault': 'Standard (pi wählt)',
  'schedules.modelClear': 'Löschen',
  'schedules.modelSearch': 'Modelle suchen…',
  'schedules.modelNone': 'Keine passenden Modelle',
  'schedules.fieldThinking': 'Denkstufe',
  'schedules.thinkingDefault': 'Standard',
  'schedules.fieldFrequency': 'Häufigkeit',
  'schedules.fieldMinute': 'Minute (0–59)',
  'schedules.fieldTime': 'Uhrzeit',
  'schedules.fieldWeekday': 'Wochentag',
  'schedules.fieldCron': 'Cron-Ausdruck',
  'schedules.cronHint': 'Standard-cron mit 5 Feldern: Minute Stunde Tag Monat Wochentag',
  'schedules.fieldTimezone': 'Zeitzone',
  'schedules.fieldEnabled': 'Aktiviert',
  'schedules.errNameRequired': 'Name ist erforderlich',
  'schedules.errInstructionsRequired': 'Anweisungen sind erforderlich',
  'schedules.errCronRequired': 'Ein cron-Ausdruck ist erforderlich',
  'schedules.freq_manual': 'Nur manuell',
  'schedules.freq_hourly': 'Stündlich',
  'schedules.freq_daily': 'Täglich',
  'schedules.freq_weekdays': 'Wochentags',
  'schedules.freq_weekly': 'Wöchentlich',
  'schedules.freq_custom': 'Benutzerdefiniert (cron)',
  'schedules.freqManual': 'Nur manuell',
  'schedules.freqHourlyAt': 'Stündlich um :{minute}',
  'schedules.freqDailyAt': 'Täglich um {time}',
  'schedules.freqWeekdaysAt': 'Wochentags um {time}',
  'schedules.freqWeeklyAt': '{day} um {time}',
  'schedules.weekday0': 'Sonntag',
  'schedules.weekday1': 'Montag',
  'schedules.weekday2': 'Dienstag',
  'schedules.weekday3': 'Mittwoch',
  'schedules.weekday4': 'Donnerstag',
  'schedules.weekday5': 'Freitag',
  'schedules.weekday6': 'Samstag',
  // ── Not found (404) ──

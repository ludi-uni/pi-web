...
export default {
  'common.closeNamed': 'Isara ang {name}',
  'index.dateToday': 'Ngayon',
  'index.dateYesterday': 'Kahapon',
  'index.datePrevious7Days': 'Nakaraang 7 araw',
  'index.datePrevious30Days': 'Nakaraang 30 araw',
  'index.dateOlder': 'Mas luma',
  'index.loadMore': 'Mag-load pa',
  'index.loadingMore': 'Naglo-load…',
  'menu.renamePrompt': 'Palitan ang pangalan ng session',
  'menu.renamed': 'Napalitan ang pangalan',
  'menu.forkFailed': 'Nabigo ang fork',
  'menu.noUserMessagesToFork': 'Walang mensahe ng user na maaaring i-fork',
  'menu.loadMessagesFailed': 'Nabigong i-load ang mga mensahe',
  'menu.cloneFailed': 'Nabigo ang clone',
  'menu.notImplemented': 'Hindi pa naipapatupad',
  // ── Diff review modal ──
  'diff.title': 'Diff',
  'diff.loading': 'Nilo-load ang diff…',
  'diff.timeout': 'Nag-time out ang diff — subukan ulit.',
  'diff.empty': 'Walang hindi na-commit na mga pagbabago',
  ...
  'diff.expandFile': 'I-expand ang file',
  'composer.modelPlaceholder': 'Model',
  'share.defaultTitle': 'Ibahagi ang session',
  'share.failedTitle': 'Nabigo ang Pagbabahagi',
  'share.successTitle': 'Naibahagi ang Session',
  'share.gistUrlLabel': 'URL ng Gist',
  'share.previewUrlLabel': 'URL ng Preview',
  'share.copyGist': 'Kopyahin ang Gist',
  'share.copyPreview': 'Kopyahin ang Preview',
  'share.gistLabel': 'Gist',
  'share.previewLabel': 'Preview',
  'share.networkError': 'Error sa network',
  ...
  'composer.queueActive': 'Pila',
  'composer.queuePaused': 'Nakahinto ang pila',
  'composer.queueQueuedCount': 'nakapila',
  'composer.queueSteeringCount': 'pinapatnubayan',
  'composer.pause': 'Ihinto',
  'composer.resume': 'Ipagpatuloy',
  'composer.queuePauseHint': 'Hawakan ang mga nakapilang mensahe hanggang ipagpatuloy mo',
  'composer.queueResumeHint':
    'Awtomatikong ipadala ang mga nakapilang mensahe kapag natapos ang kasalukuyang tugon',
  'composer.queueAria': 'Mga nakapilang mensahe',
  'composer.steerTag': 'patnubay',
  'composer.queueNavigate': 'mag-navigate',
  ...
  // ── Schedules ──
  'schedules.navTitle': 'Mga Iskedyul',
  'schedules.title': 'Mga Iskedyul',
  'schedules.new': 'Bagong iskedyul',
  'schedules.edit': 'I-edit',
  'schedules.delete': 'Tanggalin',
  'schedules.backToSessions': 'Mga Session',
  'schedules.loading': 'Naglo-load…',
  'schedules.emptyTitle': 'Wala pang iskedyul',
  'schedules.emptyHint': 'Gumawa ng iskedyul para awtomatikong patakbuhin ang pi sa isang timer.',
  'schedules.active': 'Aktibo',
  'schedules.paused': 'Naka-pause',
  'schedules.next': 'Susunod',
  'schedules.last': 'Huli',
  'schedules.runNow': 'Patakbuhin ngayon',
  'schedules.pause': 'I-pause',
  'schedules.resume': 'Ipagpatuloy',
  'schedules.runs': 'Mga takbo',
  'schedules.noRuns': 'Wala pang takbo',
  'schedules.runError': 'Error',
  'schedules.openSession': 'Buksan ang session',
  'schedules.runStarted': 'Nagsimula…',
  'schedules.confirmDelete': 'Tanggalin ang iskedyul na “{name}”?',
  'schedules.editorTitle': 'Editor ng iskedyul',
  'schedules.editTitle': 'I-edit ang iskedyul',
  'schedules.saving': 'Sine-save…',
  'schedules.fieldName': 'Pangalan',
  'schedules.namePlaceholder': 'Araw-araw na standup digest',
  'schedules.fieldInstructions': 'Mga tagubilin',
  'schedules.instructionsPlaceholder': 'Ano ang dapat gawin ng pi sa bawat takbo?',
  'schedules.fieldProject': 'Direktoryo ng proyekto',
  'schedules.projectPlaceholder': '/path/to/project (default: home)',
  'schedules.fieldModel': 'Modelo',
  'schedules.modelDefault': 'Default (pi ang pipili)',
  'schedules.modelClear': 'I-clear',
  'schedules.modelSearch': 'Maghanap ng mga modelo…',
  'schedules.modelNone': 'Walang tugmang modelo',
  'schedules.fieldThinking': 'Antas ng pag-iisip',
  'schedules.thinkingDefault': 'Default',
  'schedules.fieldFrequency': 'Dalas',
  'schedules.fieldMinute': 'Minuto (0–59)',
  'schedules.fieldTime': 'Oras',
  'schedules.fieldWeekday': 'Araw ng linggo',
  'schedules.fieldCron': 'cron expression',
  'schedules.cronHint': 'Standard na 5-field na cron: minuto oras araw buwan araw-ng-linggo',
  'schedules.fieldTimezone': 'Time zone',
  'schedules.fieldEnabled': 'Naka-enable',
  'schedules.errNameRequired': 'Kailangan ang pangalan',
  'schedules.errInstructionsRequired': 'Kailangan ang mga tagubilin',
  'schedules.errCronRequired': 'Kailangan ng cron expression',
  'schedules.freq_manual': 'Manual lamang',
  'schedules.freq_hourly': 'Oras-oras',
  'schedules.freq_daily': 'Araw-araw',
  'schedules.freq_weekdays': 'Mga araw ng trabaho',
  'schedules.freq_weekly': 'Lingguhan',
  'schedules.freq_custom': 'Custom (cron)',
  'schedules.freqManual': 'Manual lamang',
  'schedules.freqHourlyAt': 'Oras-oras sa :{minute}',
  'schedules.freqDailyAt': 'Araw-araw nang {time}',
  'schedules.freqWeekdaysAt': 'Mga araw ng trabaho nang {time}',
  'schedules.freqWeeklyAt': '{day} nang {time}',
  'schedules.weekday0': 'Linggo',
  'schedules.weekday1': 'Lunes',
  'schedules.weekday2': 'Martes',
  'schedules.weekday3': 'Miyerkules',
  'schedules.weekday4': 'Huwebes',
  'schedules.weekday5': 'Biyernes',
  'schedules.weekday6': 'Sabado',
  // ── Not found (404) ──

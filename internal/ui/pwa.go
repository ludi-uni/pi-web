...
func RegisterPWAHandlers(mux *http.ServeMux) {
	...
	// PNG rasterizations of the SVG icons — required for Android installability
	// (Chrome wants a real bitmap at 192/512) and for iOS apple-touch-icon,
	// which does not accept SVG. Generated by scripts/render-pwa-icons.mjs.
